import svgPaths from "./svg-mep99xfy8n";
...
function Frame3() {
  return (
    <a className="absolute bg-white content-stretch cursor-pointer flex h-[34px] items-center justify-center left-0 px-[14px] py-[3px] rounded-[6px] top-0 w-[35px]">
...
function Frame7() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[12px] items-start left-[304px] top-[162px] w-[871px]">
      <Frame6 />
      <Frame4 />
    </div>
  );
...
export default function HomeScreen() {
  return (
    <div className="bg-[#f7f7f7] relative size-full" data-name="Home screen">
