import svgPaths from "./svg-bkfs92o6ao";
...
function Frame10() {
  return (
    <a className="bg-white border border-[#b8b8b8] border-solid content-stretch cursor-pointer flex h-[222px] items-start p-[20px] relative rounded-[5px] shrink-0 w-full">
      <p className="[word-break:break-word] flex-[1_0_0] font-['Inter:Italic',sans-serif] font-normal h-full italic leading-[26px] min-w-px relative text-[#5f5f5f] text-[16px] text-left">|Type in a writing prompt, an assignment question, or grading rubrics to generate a template!</p>
    </a>
  );
}
...
export default function Template() {
  return (
    <div className="bg-[#f7f7f7] relative size-full" data-name="Template">
